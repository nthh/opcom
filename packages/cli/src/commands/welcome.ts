...
export async function runWelcome(): Promise<void> {
  ...
  try {
    ...
    console.log("");
    console.log(`  ${BOLD}Global state${RESET}  ${DIM}~/.opcom/${RESET}`);
    console.log(`    Config, project detection, plans, and agent sessions.`);
    console.log(`    SQLite event store (events.db) tracks all agent activity.`);
    console.log("");
    console.log(`  ${BOLD}Plans${RESET}  ${DIM}~/.opcom/plans/${RESET}`);
    console.log(`    Multi-ticket execution plans with dependency DAGs.`);
    console.log(`    Create: ${CYAN}opcom plan create${RESET}  Execute: ${CYAN}opcom plan execute${RESET}`);
    console.log("");
    console.log(`  ${BOLD}Worktrees${RESET}  ${DIM}<project>/.opcom/worktrees/${RESET}`);
    console.log(`    Agents get isolated git worktrees so they don't conflict.`);
    console.log(`    Enable with: ${CYAN}opcom work <project>/<ticket> --worktree${RESET}`);
    console.log("");

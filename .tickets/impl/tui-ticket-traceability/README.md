...
- [ ] T1: Show spec link indicator (green check if linked, red warning if not)
- [ ] T2: Show related tickets — other tickets implementing the same spec section
- [ ] T3: Show covering test files (from trace data)
- [ ] T4: Tests for traceability data in ticket view
